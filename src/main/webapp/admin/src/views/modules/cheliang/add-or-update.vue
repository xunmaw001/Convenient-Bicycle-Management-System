    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="租用原价/小时" prop="cheliangOldMoney">
                       <el-input v-model="ruleForm.cheliangOldMoney"
                                 placeholder="租用原价/小时" clearable  :readonly="ro.cheliangOldMoney"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="租用原价/小时" prop="cheliangOldMoney">
                           <el-input v-model="ruleForm.cheliangOldMoney"
                                     placeholder="租用原价/小时" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="现价/小时" prop="cheliangNewMoney">
                       <el-input v-model="ruleForm.cheliangNewMoney"
                                 placeholder="现价/小时" clearable  :readonly="ro.cheliangNewMoney"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="现价/小时" prop="cheliangNewMoney">
                           <el-input v-model="ruleForm.cheliangNewMoney"
                                     placeholder="现价/小时" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="车辆位置" prop="cheliangAddress">
                       <el-input v-model="ruleForm.cheliangAddress"
                                 placeholder="车辆位置" clearable  :readonly="ro.cheliangAddress"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="车辆位置" prop="cheliangAddress">
                           <el-input v-model="ruleForm.cheliangAddress"
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="车辆状态" prop="cheziTypes">
                        <el-select v-model="ruleForm.cheziTypes" :disabled="ro.cheziTypes" placeholder="请选择车辆状态">
                            <el-option
                                v-for="(item,index) in cheziTypesOptions"
                                v-bind:key="item.codeIndex"
                                :label="item.indexName"
                                :value="item.codeIndex">
                            </el-option>
                    ...
                    <div v-else>
                        <el-form-item class="input" label="车辆状态" prop="cheziValue">
                        <el-input v-model="ruleForm.cheziValue"
                            placeholder="车辆状态" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="租用状态" prop="zuyongTypes">
                        <el-select v-model="ruleForm.zuyongTypes" :disabled="ro.zuyongTypes" placeholder="请选择租用状态">
                            <el-option
                                v-for="(item,index) in zuyongTypesOptions"
                                v-bind:key="item.codeIndex"
                                :label="item.indexName"
                                :value="item.codeIndex">
                            </el-option>
                    ...
                    <div v-else>
                        <el-form-item class="input" label="租用状态" prop="zuyongValue">
                        <el-input v-model="ruleForm.zuyongValue"
                            placeholder="租用状态" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                rules: {
                   ...
                   cheliangOldMoney: [
                              { required: true, message: '租用原价/小时不能为空', trigger: 'blur' },
                   ...
                   cheliangNewMoney: [
                              { required: true, message: '现价/小时不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]{0,6}(\.[0-9]{1,2})?$/,
                                  message: '只允许输入整数6位,小数2位的数字',
                                  trigger: 'blur'
                              }
                   ...
                   cheliangAddress: [
                              { required: true, message: '车辆位置不能为空', trigger: 'blur' },
                          ],
                   cheziTypes: [
                   ...
                   zuyongTypes: [
                              { required: true, message: '租用状态不能为空', trigger: 'blur' },
                              {  pattern: /^[1-9][0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
        ...
        created() {
            ...
            if (this.role != "管理员"){
                this.ro.cheliangOldMoney = true;
                this.ro.cheliangNewMoney = true;
            }
            ...
            //获取下拉框信息
                ...
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=chezi_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.cheziTypesOptions = data.data.list;
                    }
                });
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=zuyong_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.zuyongTypesOptions = data.data.list;
                    }
                });
                this.$http({
