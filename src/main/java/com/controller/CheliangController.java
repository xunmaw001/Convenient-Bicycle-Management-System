    ...
    */
    ...
    public R save(@RequestBody CheliangEntity cheliang, HttpServletRequest request){
        ...
        Wrapper<CheliangEntity> queryWrapper = new EntityWrapper<CheliangEntity>()
            ...
            .eq("cheliang_address", cheliang.getCheliangAddress())
            .eq("chezi_types", cheliang.getCheziTypes())
            .eq("zuyong_types", cheliang.getZuyongTypes())
...
//                            cheliangEntity.setCheliangOldMoney(data.get(0));                    //租用原价/小时 要改的
//                            cheliangEntity.setCheliangNewMoney(data.get(0));                    //现价/小时 要改的
//                            cheliangEntity.setCheliangClicknum(Integer.valueOf(data.get(0)));   //点击次数 要改的
//                            cheliangEntity.setCheliangAddress(data.get(0));                    //车辆位置 要改的
//                            cheliangEntity.setCheziTypes(Integer.valueOf(data.get(0)));   //车辆状态 要改的
//                            cheliangEntity.setZuyongTypes(Integer.valueOf(data.get(0)));   //租用状态 要改的
...
//                            cheliangEntity.setCreateTime(date);//时间
    ...
    */
    ...
    public R list(@RequestParam Map<String, Object> params, HttpServletRequest request){
        ...
        params.put("cheziTypes","1");
        params.put("zuyongTypes","1");
        PageUtils page = cheliangService.queryPage(params);
